...
## Project Structure
    ...
    ├── test_app_event_mana_38103  # Django project configurations
...
1. Clone this repo and `cd test_app_event_mana_38103`
...
2. Clone this repo and `cd test_app_event_mana_38103`
